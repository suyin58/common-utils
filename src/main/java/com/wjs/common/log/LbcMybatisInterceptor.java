...
public class LbcMybatisInterceptor implements Interceptor {

	/**
	 * LOGGER
	 */
	protected static final Logger LOGGER = LoggerFactory.getLogger(LbcMybatisInterceptor.class);
	...
	public static void main(String[] args) {
		...
		System.out.println(StringUtils.replaceOnce("aaaaaa?bbbbb","?","11111"));
	}
